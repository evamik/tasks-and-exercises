...
Y = np.array(np.loadtxt("Kaunas University of Technology/3rd course/Numerical methods and algorithms/P3/Y.txt", delimiter=','))
X = np.array(np.loadtxt("Kaunas University of Technology/3rd course/Numerical methods and algorithms/P3/X.txt", delimiter=','))
#a = 10
#a = 20
#a = 50
a = 100
