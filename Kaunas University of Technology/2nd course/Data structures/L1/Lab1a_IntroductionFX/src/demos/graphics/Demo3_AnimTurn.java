...
//        gc.scale(0.975, 0.975);
    ...
    final Timeline anim = new Timeline(new KeyFrame(Duration.millis(16), 
            e -> eh.handle(e)));
    
    final private EventHandler ehSuite3 = e -> {
        double seconds = anim.getCurrentTime().toSeconds();
        gc.scale(1+seconds, 1+seconds);
        baseSuite3(); 
//        gc.rotate(vip.turnAngle());
//        gc.translate(5, 3);
    };
    
    final private EventHandler ehSuite4 = e -> {
//        double seconds = anim.getCurrentTime().toSeconds();
//        gc.scale(1+seconds, 1+seconds);
//        baseSuite3(); 
//        gc.rotate(vip.turnAngle());
//        gc.translate(5, 3);
    ...
    private void baseSuite3() {
        ...
        gc.fillPolygon( new double[] {-30, 0, 30}, 
                        new double[] {0, -20, 0}, 
                        3);
        gc.setFill(Color.WHITE);
        gc.fillRect(-25, 0, 50, 30);
    } 
    
    private void baseSuite4(){
    ...
    public void createControls() {
        ...
        addButton("recursion",   e -> { baseSuite4(); eh = ehSuite4; });
