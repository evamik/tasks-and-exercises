...
import edu.ktu.ds.lab3.mikalauskas.Bike;
import edu.ktu.ds.lab3.mikalauskas.BikesGenerator;
import edu.ktu.ds.lab3.mikalauskas.SimpleBenchmark;
import edu.ktu.ds.lab3.utils.CollisionHandling;
...
public class MainWindow extends BorderPane implements EventHandler<ActionEvent> {
    ...
    private void mapGeneration(String filePath) {
        ...
        createMap();
        // Jei failas nenurodytas - generuojami dviračiai ir talpinami atvaizdyje
        if (filePath == null) {
    ...
    private void createMap() {
        switch (cmbCollisionTypes.getSelectionModel().getSelectedIndex()) {
            case 0:
                ...
                break;
            case 1:
                map = new ParsableHashMap<>(String::new, Bike::new, initialCapacity, loadFactor, ht, CollisionHandling.LINEAR_PROBING);
                break;
            // ...
