...
public class AvlSet<E extends Comparable<E>> extends BstSet<E>
    ...
    private AVLNode<E> removeRecursive(E element, AVLNode<E> n) {
        ...
        else
        {
            ...
            {
                AVLNode<E> temp = (AVLNode<E>)getMin(n.getRight());
        ...
        int currentBalance = balanceFactor(n);
        if(currentBalance > 1 && balanceFactor(n.getLeft()) >= 0)
        ...
        if(currentBalance < -1 && balanceFactor(n.getRight()) <= 0)
