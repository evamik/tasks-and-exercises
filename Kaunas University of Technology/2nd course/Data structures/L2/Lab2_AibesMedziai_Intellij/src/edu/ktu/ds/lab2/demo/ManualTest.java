...
public class ManualTest {
    ...
    public static void executeTest() throws CloneNotSupportedException {
        ...
        carsSet2.addAll((BstSet<? extends Car>)carsSet);
        Ks.oun("Papildyta autoaibės kopija su addAll:");
        Ks.oun(carsSet2.toVisualizedString(""));

        Ks.oun(carsSet2.headSet(c7, false));
        Ks.oun(carsSet2.headSet(c3, true));
        Ks.oun(carsSet2.higher(c2));
        Ks.oun(carsSet2.last());
        Ks.oun(carsSet2.pollLast());
        Ks.oun(carsSet2.pollLast());
        Ks.oun(carsSet2.toVisualizedString(""));
        Ks.oun(carsSet2.floor(c5));
        Ks.oun(carsSet.toVisualizedString(""));
        carsSet.removeAll((BstSet<? extends Car>)carsSet2);
        Ks.oun(carsSet.toVisualizedString(""));
